...
> **Status: DRAFT — pending ratification.** Wyrd adopts the [Contributor Covenant](https://www.contributor-covenant.org) v2.1 (below). The **Values** are Wyrd's own, adapted from [The Apache Way](https://apache.org/theapacheway/). In Wyrd, the Covenant's "community leaders" are the **maintainers and the architecture board**; reports go to **policy@getwyrd.dev**; and removing an Associate, Maintainer, or board member as enforcement follows the *Removal for cause* process in [GOVERNANCE.md](GOVERNANCE.md).
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders responsible for enforcement at policy@getwyrd.dev. All complaints will be reviewed and investigated promptly and fairly.
