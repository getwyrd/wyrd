...
The design documentation is organized into four distinct classes, each with its
own purpose, audience, and change process. The distinction matters because parts
of this documentation are not merely *descriptive* — they are *normative*. An
independent implementation of the on-disk format must conform to a written
