...
| [0017](draft/0017-blackbox-validation-tool.md) | Blackbox protocol, workflow and endurance validation (`wyrd-validate`) | draft (tracker: [#735](https://github.com/getwyrd/wyrd/issues/735)) |
