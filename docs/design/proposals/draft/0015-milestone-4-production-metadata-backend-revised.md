...
This draft **proposes to supersede** [0007](../accepted/0007-milestone-4-production-metadata-backend.md)
(on acceptance) with review-pass refinements; the metadata swap, the TiKV transactional mapping, and
the DST discipline carry over unchanged. What differs:
