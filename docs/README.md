...
> `getwyrd.dev`. The name and the component-naming scheme are explained in
> [ADR-0017](design/adr/0017-project-name-and-norn-scheme.md).

This repository is the **single source of truth** for Wyrd's documentation. It is
authored in Markdown — editable in Obsidian, Git, or any editor — and published
as a static site to `getwyrd.dev`.
...
docs are organized and the recommended reading order for newcomers.
